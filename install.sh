...
wget https://assets.checkra.in/downloads/linux/cli/arm64/43019a573ab1c866fe88edb1f2dd5bb38b0caf135533ee0d6e3ed720256b89d0/checkra1n -O /opt/microrain
sudo chmod +x /opt/microrain/checkra1n
echo "Microrain downloaded all dependencies, setting up..."	
sudo cp checkra1n.service /opt/microrain
